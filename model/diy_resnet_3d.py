...
def DIY_ResNet10(*, weightspath= None, num_classes=2, **kwargs: Any) -> ResNet:
...
def DIY_ResNet18(*, weightspath= None, num_classes=2, **kwargs: Any) -> ResNet:
