...
class DIY_Folder(torch.utils.data.Dataset):
    def __init__(self, num_classes,data_path, loader=nii_loader,train_form = "None",root_mask_radiomics="",use_radiomics=True,istest=False,sec_pair_orig=False,multiclass = True):
