...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (img,_,target, saffix, sradiomics) in enumerate(train_loader):
        ...
        spare_selfKL_criterion = SelfKL(num_classes=3,lambda_0=opt.lambda_0,lambda_1=opt.lambda_1,lambda_2=opt.lambda_2,lambda_3=opt.lambda_2, CE_or_KL=opt.CE_or_KL) 
